...
public class Drive extends SubsystemBase {
  ...
  public Drive(DriveIO io) {
    ...
    HashMap<DriveState, Runnable> periodicHash = new HashMap<>();
    periodicHash.put(DriveState.kDefault, this::defaultPeriodic);
    m_profiles = new SubsystemProfiles<>(periodicHash, DriveState.kDefault);
  }
